        ...
        <div class="my-4">
            <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                <li class="nav-item">
                    <a style="background-color: #2E9AFE;color: white" class="nav-link active" id="home-tab"
                        data-toggle="tab" role="tab" aria-controls="home" aria-selected="false"><b>Cadastrar ou Alterar Contato do(a) Coordenador(a) Pedagógico <?php echo $values["coordenador_pedagogico"]; ?></b></a>
                </li>
            </ul>
            ...
            <?php } ?>
                ...
                <div class="col">
                            ...
                            <form class="form-group" action="/usuario/cadastrar-alterar-contato-coordenador/registro/<?php echo $values["id_coordenador"]; ?>" method="post"
                                ><br>
                                ...
                                <div class="form-group"><label class="small mb-1"><b
                                    ...
                                    <input class="form-control py-1" placeholder="Exemplo 61955554444"
                                      value="<?php echo $values["telefone_coordenador"]; ?>"  type="text" name="telefone_coordenador" />
                                </div>
