      ...
      <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
        <li class="nav-item">
          <a style="background-color: #2E9AFE;color: white" class="nav-link active" id="home-tab" data-toggle="tab"
            role="tab" aria-controls="home" aria-selected="false"><b>Alterar Benefício - <?php echo $value["nome"]; ?> </b></a>
        </li>
      </ul>
      <?php if( $CallOpenMsg != '' ){ ?>
      ...
      <div class="container-fluid px-1 py-5 mx-auto">
        <div class="row d-flex justify-content-center">
          <div class="col-xl-12 col-lg-8 col-md-9 col-11 text-center">
            ...
            <form class="form-group" action="/usuario/beneficio/editar/<?php echo $value["id_beneficio"]; ?>" method="post"
              enctype="multipart/form-data">

              <input class="form-control py-1" value="<?php echo $value["id_beneficio"]; ?>" name="id_beneficio" type="hidden">
          ...
          <table class="table table-hover table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td> <input name="inicio" type="date" value="<?php echo $value["inicio"]; ?>" class="form-control py-1"></td>
                <td> <input name="fim" type="date" value="<?php echo $value["fim"]; ?>" class="form-control py-1"></td>
                <td> <input name="processo" value="<?php echo $value["processo"]; ?>" class="form-control py-1"></td>
                <td> <input name="data_processo" type="date" value="<?php echo $value["data_processo"]; ?>" class="form-control py-1">
                </td>
                <td> <select class="form-control py-1" name="carencia" id="carencia">
                    <option value="<?php echo $value["carencia"]; ?>"><?php echo $value["carencia"]; ?></option>
        ...
        <b>2. Benefício, à Folha/Ano - Situação no Sistema</b>
        ...
        <div class="table-responsive">
          <table class="table table-hover table-bordered">
            ...
            <tbody>
              ...
              <tr>
                <td> <select class="form-control py-1" name="mes" id="mes">
                   <option value="<?php echo $value["mes"]; ?>"><?php echo $value["mes"]; ?></option>
                ...
                <td>
                  <select class="form-control py-1" name="beneficio" id="beneficio">
                    <option value="<?php echo $value["beneficio"]; ?>"><?php echo $value["beneficio"]; ?></option>
                ...
                <td> <select class="form-control py-1" name="situacao" id="situacao">
                  ...
                  <td>
                  <select class="form-control py-1" name="exercicio" id="exercicio" >
                    <option value="<?php echo $value["exercicio"]; ?>"><?php echo $value["exercicio"]; ?></option>
            ...
            <tbody>
              ...
              <tr>
                <td> <textarea style="height: 110px;" class="form-control py-1" value="" type="text"
                    name="observacoes"><?php echo $value["observacoes"]; ?></textarea></td>
              </tr>
