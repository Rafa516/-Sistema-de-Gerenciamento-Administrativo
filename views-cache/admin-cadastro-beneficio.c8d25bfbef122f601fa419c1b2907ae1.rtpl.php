      ...
      <div class="container-fluid px-1 py-5 mx-auto">
        <div class="row d-flex justify-content-center">
          <div class="col-xl-12 col-lg-8 col-md-9 col-11 text-center">
            ...
            <form class="form-group" action="/admin/registrar-beneficios/enviar" method="post">
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-group" action="/admin/registrar-temporarios-modal-beneficios/enviar" method="post">
