            ...
            <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                <li class="nav-item">
                    <a style="background-color: #2E9AFE;color: white" class="nav-link active" id="home-tab"
                        data-toggle="tab" role="tab" aria-controls="home" aria-selected="false"><b>Aalterar Dados
                        </b></a>
                </li>
            </ul>
            ...
            <div class="container-fluid px-1 py-5 mx-auto">
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-12 col-lg-8 col-md-9 col-11 text-center">
                        ...
                        <form class="form-group" action="/usuario/temporario-alterar/<?php echo $value["id_temporario"]; ?>" method="post">

                     <!-- <input class="form-control py-1" value="<?php echo $usuario["id_usuario"]; ?>" name="id_usuario" type="hidden"> -->

                     <input class="form-control py-1" value="<?php echo $value["id_temporario"]; ?>" name="id_temporario" type="hidden"> 


                    </div>
                </div>

                <b>1. Identificação do Servidor</b><br><br>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td   >
                                    <input value="<?php echo $value["nome"]; ?>" class="form-control py-1" type="text" name="nome" required />

                                </td>

                                <td >
                                    <input value="<?php echo $value["matricula"]; ?>" class="form-control py-1" type="text" name="matricula" required />

                                </td>
                                <td >
                                    <input value="<?php echo $value["cpf"]; ?>" class="form-control py-1" type="text" name="cpf" required />
                            ...
                            <tr>
                                <td colspan="2">
                                    <select class="form-control py-1" id="" name="componente" required>
                                        <option value="<?php echo $value["componente"]; ?>"><?php echo $value["componente"]; ?></option>
