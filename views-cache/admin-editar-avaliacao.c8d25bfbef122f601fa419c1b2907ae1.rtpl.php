<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content">
    ...
    <div class="content-inside">
            ...
            <div class="container-fluid px-1 py-5 mx-auto">
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-12 col-lg-8 col-md-9 col-11 text-center">
                        ...
                        <form class="form-group" action="/admin/avaliacao/editar/<?php echo $value["id_avaliacao"]; ?>" method="post">
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a target="_blank" href="/admin/cadastrar-unidade"
        ...
        <a href="/admin/avaliacoes" class="btn btn-info btn-xs"><i class="fas fa-chevron-circle-left"></i><b>
                Voltar</b></a>
