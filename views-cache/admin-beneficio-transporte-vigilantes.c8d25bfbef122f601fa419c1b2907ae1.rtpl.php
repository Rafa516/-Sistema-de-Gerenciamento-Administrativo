<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content">
    <div class="content-inside">
      <div class="my-4">
        ...
        <a data-toggle="modal" data-target="#modalCalcularRepag" style="width: 20%;" href="/admin/beneficio/transporte-efetivos"
          class="btn btn-primary btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i><b> Cadastrar
            Benefício</b></a>
  
         <a href="/admin/beneficio/transporte-efetivos" class="btn btn-info btn-sm"><i class="fas fa-users"></i><b> Transporte Efetivos</b></a>
      ...
      <!--   <a href="/admin/beneficio/alimentacao" class="btn btn-info btn-sm"><i class="fas fa-bread-slice"></i><b> Auxílio
            Alimentação</b></a>
   -->
        <?php if( $total > 0 ){ ?>
        <div class="search" style="float: right">
          <form action="/admin/beneficio/transporte-vigilantes" method="get">
          ...
          <table class=" table table-hover table-sm  table-bordered">
            ...
            <tbody>
              ...
              <tr style="font-size: 15px;font-weight: normal;">
                ...
                <td>
                  <center> <a href="/admin/transporte-efetivo-visualizar/<?php echo $value1["id_beneficio_efetivo"]; ?>"
                ...
                <td>
                  <center>
                    <button
                      onclick="deletar('<?php echo $value1["id_beneficio_efetivo"]; ?>','<?php echo $value1["nome_servidor"]; ?>','/admin/beneficio-transporte-vigilantes/delete/<?php echo $value1["id_beneficio_efetivo"]; ?>,<?php echo $usuario["nome_user"]; ?>','Excluir Transporte')"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Cadastrar Valor do Auxílio Transporte</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form class="form-group" name="form_repag" action="/admin/registrar-transporte-efetivo/enviar" method="post">
            ...
            <select class="js-example-basic-single" id="componente" name="id_efetivo" required style="width: 70%;display: inline-block">
              <option value="">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><b><span id="receber_b"></b></span><input type="hidden" id="receber_beneficio" name="receber"
                        value=""></td>
                    <td><b><span id="devolver_b"></b></span><input type="hidden" id="devolver_beneficio" name="devolver"
                        value=""></td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class="form-group" action="/admin/registrar-efetivos-modal/enviar" method="post">
