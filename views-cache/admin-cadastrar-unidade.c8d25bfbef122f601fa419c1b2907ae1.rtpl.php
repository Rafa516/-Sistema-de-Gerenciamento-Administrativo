<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content">
    ...
    <div class="content-inside">
        ...
        <div class="my-4">
                ...
                <div class="col">
                    ...
                    <div class="row mb-7">
                        <div class="col-md-10">
                            ...
                            <form class="form-group" action="/admin/cadastrar-unidade/registro" method="post"
                               ...
                               <div class="form-group"><label class="small mb-1"><b
                                ...
                                <div class="form-group"><label class="small mb-1"><b b
                                            style="font-size:20px;color: #585858">Imagens</b></label>
            ...
            <a href="/admin/unidades/localidades" class="btn btn-info btn-xs"><i class="fas fa-chevron-circle-left"></i><b>
                Voltar</b></a>
        </div>
