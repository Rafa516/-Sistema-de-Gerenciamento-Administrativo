            ...
            <tr style="font-size: 15px;font-weight: normal;">
              ...
              <td class="remover">    
               ...
               <td class="remover">
                  <center>
                    <button
                    onclick="deletar('<?php echo $value1["id_beneficio"]; ?>','<?php echo $value1["nome"]; ?>','/admin/beneficio/delete/<?php echo $value1["id_beneficio"]; ?>,<?php echo $usuario["nome_user"]; ?>','Excluir Alimentação')"
