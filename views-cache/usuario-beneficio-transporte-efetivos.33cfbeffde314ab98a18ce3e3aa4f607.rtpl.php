          ...
          <tbody>
            ...
            <tr style="font-size: 15px;font-weight: normal;">
              ...
              <td>
                <center>
                  <button
                    onclick="deletar('<?php echo $value1["id_beneficio_efetivo"]; ?>','<?php echo $value1["nome_servidor"]; ?>','/usuario/beneficio-transporte-efetivo/delete/<?php echo $value1["id_beneficio_efetivo"]; ?>,<?php echo $usuario["nome_user"]; ?>','Excluir Transporte')"
