<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content">
  <div class="content-inside">
            ...
            <tbody>
              ...
              <table class="table table-hover table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    <center> <a href="/usuario/unidade/localizacao/<?php echo $value["id_unidade"]; ?>" class="btn btn-info btn-sm">
                ...
                <tr >
                  <td  colspan="3" >
                    ...
                    <button
                    onclick="deletar('<?php echo $value1["id_supervisor"]; ?>','<?php echo $value1["supervisor"]; ?>','/usuario/delete/supervisor/<?php echo $value1["id_supervisor"]; ?>','Excluir Supervisor')"
                  ...
                  <a href="/usuario/cadastrar-alterar-contato-supervisor/<?php echo $value1["id_supervisor"]; ?>" class="btn btn-primary btn-sm" target="_blank">Adicionar</a>

                   <?php }else{ ?>
                   <?php echo $value1["telefone_supervisor"]; ?> 

                   <a href="/usuario/cadastrar-alterar-contato-supervisor/<?php echo $value1["id_supervisor"]; ?>" class="btn btn-info btn-sm" target="_blank"><i class="fas fa-pen" aria-hidden="true"></i></a>
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <?php $counter1=-1;  if( isset($coordenadores) && ( is_array($coordenadores) || $coordenadores instanceof Traversable ) && sizeof($coordenadores) ) foreach( $coordenadores as $key1 => $value1 ){ $counter1++; ?>
                      <tr >
                        ...
                        <td colspan="2">
                          ...
                          <button
                          onclick="deletar('<?php echo $value1["id_coordenador"]; ?>','<?php echo $value1["coordenador_pedagogico"]; ?>','/usuario/delete/coordenador/<?php echo $value1["id_coordenador"]; ?>','Excluir Coordenador')"
                          class="btn btn-danger btn-sm">
                          <i class="fas fa-trash-alt"></i>
                          </button>
                        </td>
                  ...
                  <a href="/usuario/cadastrar-alterar-contato-coordenador/<?php echo $value1["id_coordenador"]; ?>" class="btn btn-primary btn-sm" target="_blank">Adicionar</a>

                   <?php }else{ ?>
                   <?php echo $value1["telefone_coordenador"]; ?> 

                   <a href="/usuario/cadastrar-alterar-contato-coordenador/<?php echo $value1["id_coordenador"]; ?>" class="btn btn-info btn-sm" target="_blank"><i class="fas fa-pen" aria-hidden="true"></i></a>
    ...
    <?php }else{ ?>
    <a href="/usuario/unidade/fotos/<?php echo $value["id_unidade"]; ?>" class="btn btn-warning btn-sm">
    ...
    <a href="/usuario/dados-unidades" class="btn btn-info btn-xs"><i class="fas fa-chevron-circle-left"></i><b>
        Voltar</b></a>
  </div>
</div>
</div>
  ...
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <div class="modal-body">
              <form class="form-group" action="/usuario/unidade/fotos/post/<?php echo $value["id_unidade"]; ?>"
...
<div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="registerModal"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php if( $value["unidade"] == 'Unidade Escolar' ){ ?>
        <form class="form-group" action="/usuario/unidade/editar/<?php echo $value["id_unidade"]; ?>" method="post"><br>
        ...
        <form class="form-group" action="/usuario/unidade-administrativa/editar/<?php echo $value["id_unidade"]; ?>" method="post"><br>
