<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content">
  <div class="content-inside">
            ...
            <tr style="font-size: 15px;font-weight: normal;">
              ...
              <td>
               ...
               <td>
                  <center>
                    <button
                    onclick="deletar('<?php echo $value1["id_arquivoD"]; ?>','<?php echo $value1["arquivo_documento"]; ?>','/usuario/documentos-arquivo/delete/<?php echo $value1["id_arquivoD"]; ?>,<?php echo $usuario["nome_user"]; ?>','Excluir Arquivo')"
    ...
    <?php } ?>
      ...
      <a href="/usuario/todos-documentos" class="btn btn-info btn-xs"><i class="fas fa-chevron-circle-left"></i><b>
          Voltar</b></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-group" action="/usuario/documento/anexar-arquivo/<?php echo $value["id_documento"]; ?>" method="post"
