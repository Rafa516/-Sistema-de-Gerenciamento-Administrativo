          ...
          <table class=" table table-hover table-sm  table-bordered">
            ...
            <tbody>
              ...
              <tr style="font-size: 15px;font-weight: normal;">
                ...
                <td>
                  <center><a style="text-decoration: none;" href="/usuario/editar-avaliacao/<?php echo $value1["id_avaliacao"]; ?>"><?php echo $value1["sigla"]; ?></a>
                </td>
                <td>
                  <center>
                    <button
            onclick="deletar('<?php echo $value1["id_avaliacao"]; ?>','<?php echo $value1["sigla"]; ?>','/usuario/avaliacao/delete/<?php echo $value1["id_avaliacao"]; ?>,<?php echo $usuario["nome_user"]; ?>','Excluir Avaliação')"
