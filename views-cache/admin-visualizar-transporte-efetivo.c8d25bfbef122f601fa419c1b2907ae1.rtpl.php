<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content">
  <div class="content-inside">
                ...
                <table class="table table-hover table-bordered">
                  ...
                  <table class="table table-hover table-bordered">
                    ...
                    <table class="table table-hover table-bordered">
                      ...
                      <td>
                        <center><b><?php echo $value1["frequencia"]; ?></b>
                      </td>
                      <td colspan="2">
                        <center><a target="_blank"
                            href="/admin/itinerario-visualizar/<?php echo $value1["id_itinerarios"]; ?>"><?php echo $value1["nome_itinerario"]; ?></a>
                      </td>
                      <td>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <center><a href="/admin/alterar-repag-transporte-efetivo/<?php echo $value1["id_repag_efetivo"]; ?>"
                                class="btn btn-success btn-sm"><i class="fas fa-pen"></i><b></b></a>


                              <button
                                onclick="deletar('<?php echo $value1["id_repag_efetivo"]; ?>','<?php echo $value1["frequencia"]; ?>','/admin/repag/delete/<?php echo $value1["id_repag_efetivo"]; ?>,<?php echo $usuario["nome_user"]; ?>','Excluir Repag')"
    ...
    <a href="/admin/beneficio/transporte-efetivos" class="btn btn-info btn-xs"><i
  ...
  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-group" action="/admin/incluir-observacao-transporte/enviar/<?php echo $value["id_beneficio_efetivo"]; ?>"
          method="post">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-group" name="form_repag"
          action="/admin/registrar-repag-transporte-efetivo/<?php echo $value["id_beneficio_efetivo"]; ?>" method="post">
...
<div class="modal fade" id="modalAlterarDados" tabindex="-1" role="dialog" aria-labelledby="modalAlterarDadosTitle"
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-group" action="/admin/transporte/editar/<?php echo $value["id_beneficio_efetivo"]; ?>" method="post">
