<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content">
  <div class="content-inside">
    <div class="my-4">
      <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
        <li class="nav-item">
          <a style="background-color: #2E9AFE;color: white" class="nav-link active" id="home-tab" data-toggle="tab"
            role="tab" aria-controls="home" aria-selected="false"><b>Informações</b></a>
        </li>
      </ul>
      ...
      <a style="width: 25%;" href="/usuario/informacoes/registro" class="btn btn-primary btn-sm"><i
          class="fa fa-plus-circle" aria-hidden="true"></i><b> Registrar Informação</b></a>

      <div class="search" style="float: right">
        <form action="/usuario/informacoes" method="get">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <i class="fa fa-calendar-alt"></i>&nbsp;&nbsp;<?php echo formatDateHoras($value1["dt_registro_informacao"]); ?>
        </div>

        <Center>
          <h2 class="card-title"><?php echo $value1["titulo"]; ?></h2>
        </Center>
        ...
        <div class="card-footer text-muted">
          <center>
            ...
            <?php } ?>
            <a href="/usuario/informacoes/alterar/<?php echo $value1["id_informacao"]; ?>" class="btn btn-success btn-sm">
              <i class="fas fa-pen"></i>
              <b>Alterar</b></a>

            <button
              onclick="deletar('<?php echo $value1["id_informacao"]; ?>','<?php echo $value1["titulo"]; ?>','/usuario/informacoes/delete/<?php echo $value1["id_informacao"]; ?>,<?php echo $usuario["nome_user"]; ?>','Excluir Informação')"
