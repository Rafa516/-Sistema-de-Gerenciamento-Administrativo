<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content">
  <div class="content-inside">
                  ...
                  <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>                         
                              <center><a href="/admin/alterar-repag-transporte-temporario/<?php echo $value1["id_repag_temporario"]; ?>" class="btn btn-success btn-sm"><i
                                class="fas fa-pen"></i><b></b></a>


                          <button
                            onclick="deletar('<?php echo $value1["id_repag_temporario"]; ?>','<?php echo $value1["frequencia"]; ?>','/admin/repag-temporario/delete/<?php echo $value1["id_repag_temporario"]; ?>,<?php echo $usuario["nome_user"]; ?>','Excluir Repag')"
    ...
    <i>Última alteração registrada pelo(a) usuário(a)<b> <?php echo $value["nome_user"]; ?></b> em <b><?php echo formatDateHoras($value["dt_registro_beneficio"]); ?>.</b></i><br><br>
     ...
     <a href="/admin/beneficio/editar/<?php echo $value["id_beneficio"]; ?>" class="btn btn-success btn-sm"><i
...
<div class="modal-content">
  ...
  <div class="modal-body">
    <form class="form-group" name="form_repag"
      action="/admin/registrar-repag-transporte-temporario/<?php echo $value["id_beneficio"]; ?>" method="post">
