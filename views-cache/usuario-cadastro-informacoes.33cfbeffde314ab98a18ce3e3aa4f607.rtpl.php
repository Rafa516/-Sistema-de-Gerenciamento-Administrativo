    ...
    <div class="content-inside">
      ...
      <div class="my-4">
        <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
          <li class="nav-item">
            <a style="background-color: #2E9AFE;color: white" class="nav-link active" id="home-tab" data-toggle="tab"
              role="tab" aria-controls="home" aria-selected="false"><b>Registrar Informacoes</b></a>
          </li>
        </ul>
        <?php if( $CallOpenMsg != '' ){ ?>
        ...
        <div class="container-fluid px-1 py-5 mx-auto">
          ...
          <form class="form-group" action="/usuario/informacoes/registrar" method="post">
          ...
          <input class="form-control py-1" value="<?php echo $usuario["id_usuario"]; ?>" name="id_usuario" type="hidden">
            <div class="table-responsive">
              <table class="table table-hover table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    <td> <input name="titulo" type="text" class="form-control py-1" required></td>
                  </tr>
                </tbody>
            ...
            <b>Informações referentes as Rotinas do trabalho</b></b><br><br>
            ...
            <center><input style="width: 100%;" class="btn btn-primary btn" type="submit" value="Cadastrar"></center><br><br>
        </div>
