  ...
  <div class="content-inside">
    <div class="my-4">
      ...
      <div class="search" style="float: right">
        <form action="/usuario/dados-unidades" method="get">
        ...
        <table class=" table table-hover table-sm  table-bordered">
          ...
          <tbody>
            ...
            <tr style="font-size: 15px;font-weight: normal;">
              ...
              <td>
                <center><?php echo formatDate($value1["dt_registro_unidade"]); ?>
              </td>
              ...
              <td>
                <center><button
                    onclick="deletar('<?php echo $value1["id_unidade"]; ?>','<?php echo $value1["sigla"]; ?>','/usuario/unidade/delete/<?php echo $value1["id_unidade"]; ?>,<?php echo $usuario["nome_user"]; ?>','Excluir UE ou CRE')"
