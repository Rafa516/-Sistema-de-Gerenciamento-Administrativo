  ...
  <div class="content-inside">
    ...
    <div class="my-4">
      ...
      <div class="row mt-5 align-items-center">
        <div class="col-md-3 text-center mb-5">
          <div class="avatar avatar-xl">
            ...
            <img src="/res/ft_perfil/<?php echo $usuario["foto"]; ?>" class="avatar-img rounded-circle" height="250"  alt="">
            <?php } ?>
      ...
      <center><button data-toggle="modal" onclick="alertAlterarDados()" data-target="#dateModal"
        ...
        <button data-toggle="modal" data-target="#dateModal1" class="btn btn-success"><b>Alterar senha</b> </button>
      </center>
      <hr class="my-4" />
