  ...
  <div class="content-inside">
    <div class="my-4">
      <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
        ...
        <a style="width: 20%;" href="/usuario/registrar-beneficios"class="btn btn-primary btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i><b> Cadastrar Benefício</b></a>
        <a href="/usuario/beneficio/transporte" class="btn btn-info  btn-sm"><i class="fas fa-bus"></i><b> Auxílio Transporte</b></a>
      ...
      <div class="search" style="float: right">
        <form action="/usuario/beneficio/alimentacao" method="get">
        ...
        <table class=" table table-hover table-sm  table-bordered">
          ...
          <tbody>
            ...
            <tr style="font-size: 15px;font-weight: normal;">
              ...
              <td>
                <center><?php if( $value1["carencia"] == 'Curta' ){ ?>
              ...
              <td class="remover">    
                <center> <a  href="/usuario/beneficios-visualizar/<?php echo $value1["id_beneficio"]; ?>"
               ...
               <td class="remover">
                  <center>
                    <button
                    onclick="deletar('<?php echo $value1["id_beneficio"]; ?>','<?php echo $value1["nome"]; ?>','/usuario/beneficio/delete/<?php echo $value1["id_beneficio"]; ?>,<?php echo $usuario["nome_user"]; ?>',' Excluir Alimentação')"
