<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content">
  <div class="content-inside">
    <div class="my-4">
      ...
      <a data-toggle="modal" data-target="#modalCalcularRepag" style="width: 20%;" href="/admin/registrar-beneficios"
        class="btn btn-primary btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i><b> Cadastrar
          Benefício</b></a>

        <a href="/admin/beneficio/transporte-vigilantes" class="btn btn-info btn-sm"><i class="fas fa-user-shield"></i><b> Transporte Vigilantes</b></a>
 ...
 -->
      ...
      <div class="search" style="float: right">
        <form action="/admin/beneficio/transporte-efetivos" method="get">
