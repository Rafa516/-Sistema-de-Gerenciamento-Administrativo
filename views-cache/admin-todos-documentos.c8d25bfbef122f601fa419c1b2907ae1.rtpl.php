  ...
  <div class="content-inside">
    <div class="my-4">
      <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
        ...
        <a style="width: 20%;" href="/admin/registrar-documentos"class="btn btn-primary btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i><b> Registrar documento</b></a>
     

        <?php if( $total > 0 ){ ?>

      <div class="search" style="float: right">
        <form action="/admin/todos-documentos" method="get">
        ...
        <table class=" table table-hover table-sm  table-bordered">
          ...
          <tbody>
            ...
            <tr style="font-size: 15px;font-weight: normal;">
              ...
              <td>
               <center> <a  href="/admin/todos-documentos/arquivos/<?php echo $value1["id_documento"]; ?>"
               ...
               <td>
                  <center> <a  href="/admin/documento/editar/<?php echo $value1["id_documento"]; ?>"
                    class="btn btn-success btn-sm"><i class="fas fa-pen"></i><b></b></a></center>
              </td>
               <td>
                  <center>
                    <button
                    onclick="deletar('<?php echo $value1["id_documento"]; ?>','<?php echo $value1["nome_documento"]; ?>','/admin/documentos/delete/<?php echo $value1["id_documento"]; ?>,<?php echo $usuario["nome_user"]; ?>','Excluir ')"
