  ...
  <div class="content-inside">
    <div class="my-4">
      ...
      <?php } ?>
        ...
        <a style="width: 25%;" href="/usuario/cadastrar-itinerarios"class="btn btn-primary btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i><b> Cadastrar Itinerário</b></a>
      ...
      <div class="search" style="float: right">
        <form action="/usuario/todos-itinerarios" method="get">
          ...
          <tbody>
            ...
            <tr style="font-size: 15px;font-weight: normal;">
              ...
              <td>
               ...
               <td>
                  <center> <a  href="/usuario/itinerario-visualizar/<?php echo $value1["id_itinerarios"]; ?>"
              ...
              <td>
                <center>
                    <button
                    onclick="deletar('<?php echo $value1["id_itinerarios"]; ?>','<?php echo $value1["nome_itinerario"]; ?>','/usuario/itinerario/delete/<?php echo $value1["id_itinerarios"]; ?>,<?php echo $usuario["nome_user"]; ?>','Excluir Itinerário')"
