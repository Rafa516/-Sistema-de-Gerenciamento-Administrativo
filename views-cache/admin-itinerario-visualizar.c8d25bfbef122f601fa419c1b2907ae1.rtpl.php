                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        ...
                        <button
                          onclick="deletar('<?php echo $value1["id_itinerarios_linhas"]; ?>','<?php echo $value1["cidade_linha"]; ?>','/admin/delete/itinerario-linha/<?php echo $value1["id_itinerarios_linhas"]; ?>','Excluir Linha deste Itinerario')"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-group" action="/admin/itinerario/editar/<?php echo $value["id_itinerarios"]; ?>" method="post">
