    ...
    <div class="content-inside">
      <div class="my-4">
        <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
          ...
          <a href="/usuario/beneficio/alimentacao" class="btn btn-info btn-sm"><i class="fas fa-bread-slice"></i><b> Auxílio Alimentação</b></a> 
        ...
        <div class="search" style="float: right">
          <form action="/usuario/beneficio/transporte" method="get">
               ...
               <?php }elseif( $value1["situacao"] == 'Ajustar Benefício' ){ ?>
                ...
                <td>    
                 ...
                 <td>
                    <center>
                      <button
                      onclick="deletar('<?php echo $value1["id_beneficio"]; ?>','<?php echo $value1["nome"]; ?>','/usuario/beneficio/delete/<?php echo $value1["id_beneficio"]; ?>,<?php echo $usuario["nome_user"]; ?>','Excluir Transporte')"
