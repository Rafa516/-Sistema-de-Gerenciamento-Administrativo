<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content">
    <div class="content-inside">
        <div class="my-4">
            ...
            <center><a style="width: 25%;" href="/admin/cadastrar-unidade"class="btn btn-primary btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i><b> Cadastrar Unidade Escolar</b></a>
            <a style="width: 25%;" href="/admin/dados-unidades"class="btn btn-info btn-sm"><i class="fa fa-table" aria-hidden="true"></i><b> Visualizar dados </b></a></center><br>
     ...
     <!-- for (var i = 0; i < planes.length; i++) {
        marker = new L.marker([planes[i][4],planes[i][5]],{icon: muxiIcon})
           .bindPopup("<b style='font-size:16px;'>" +planes[i][0]+"</b>"
              ...
              +"<br>" +planes[i][2]
              + "<center><br><a href='/admin/unidades/imagens/"+planes[i][6]
