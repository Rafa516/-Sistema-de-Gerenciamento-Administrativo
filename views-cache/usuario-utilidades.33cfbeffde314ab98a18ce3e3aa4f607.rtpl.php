  ...
  <div class="content-inside">
    ...
    <center><img src="../res/user/img/logo.png" class="logo" alt=""><br><br>
     ...
     <div class="btn-group" role="group">
      ...
      <a href="/usuario/minhas-anotacoes" class="btn btn-primary  "><i class="far fa-clipboard"></i> Minhas
        anotações</a>

        <button class="btn btn-primary" data-toggle="modal"
        data-target="#modalParametrosTransporte"><i class="fas fa-file-invoice-dollar"></i> Parâmetros Auxílio Transporte</button>

        <a href="/usuario/todos-documentos" class="btn btn-primary" ><i class="fas fa-file" ></i><span> Documentos </span></a>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
             <center>
              ...
              <a href="/usuario/todos-itinerarios"  class="btn btn-primary btn-sm"><i class="fas fa-bus"></i><span> Itinerários</span></a>

              <a href="/usuario/linhas" class="btn btn-primary btn-sm"><i class="fas fa-map-marker-alt"></i><span> Linhas</span></a>
         ...
         <div class="modal-content">
           ...
           <div class="modal-body">
            <center>
              ...
              <a href="/usuario/todos-efetivos" class="btn btn-primary btn-sm"><i class="fas fa-users"></i> Servidores</a>
              ...
              <a href="/usuario/beneficio/transporte-efetivos" class="btn btn-primary btn-sm"><i class="fas fa-bus"></i><span> Auxílio Transporte</span></a>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
             <center>
               ...
               <a href="/usuario/todos-dossiers-temporarios" class="btn btn-primary btn-sm"><i class="fas fa-address-card"></i><span> Dossiê</span></a>

               <a href="/usuario/todos-temporarios" class="btn btn-primary btn-sm"><i class="fas fa-users"></i> Contratos</a>

                <a href="/usuario/avaliacoes" class="btn btn-primary btn-sm"><i class="fas fa-tasks"></i> Avaliações</a>

               <a href="/usuario/beneficio/alimentacao" class="btn btn-primary btn-sm"><i class="fas fa-bread-slice"></i><span> Auxílio Alimentação</span></a> 

               <a href="/usuario/beneficio/transporte" class="btn btn-primary btn-sm"><i class="fas fa-bus"></i><span> Auxílio Transporte</span></a>
               <a href="/usuario/pagamentos-temporarios" class="btn btn-primary btn-sm"><i class="fas fa-money-bill-alt"></i><span> Pagamentos</span></a>
       ...
       <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
         <div class="modal-content">
           ...
           <div class="modal-body">
            ...
            <form class="form-group" action="/usuario/cadastrar-componente/registro" method="post">
               ...
               <tbody>
                <?php $counter1=-1;  if( isset($componentes) && ( is_array($componentes) || $componentes instanceof Traversable ) && sizeof($componentes) ) foreach( $componentes as $key1 => $value1 ){ $counter1++; ?>
                 <tr>
                   ...
                   <td>
                     <center> <button
                    onclick="deletar('<?php echo $value1["id_componente"]; ?>','<?php echo $value1["componente"]; ?>','/usuario/componente/delete/<?php echo $value1["id_componente"]; ?>','Excluir Componente')"
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
           ...
           <form class="form-group" action="/usuario/cadastrar-cidade/registro" method="post">
              ...
              <tbody>
               <?php $counter1=-1;  if( isset($cidades) && ( is_array($cidades) || $cidades instanceof Traversable ) && sizeof($cidades) ) foreach( $cidades as $key1 => $value1 ){ $counter1++; ?>
                <tr>
                  ...
                  <td>
                    <center> <button
                   onclick="deletar('<?php echo $value1["id_cidade"]; ?>','<?php echo $value1["cidade"]; ?>','/usuario/cidade/delete/<?php echo $value1["id_cidade"]; ?>','Excluir Cidade')"
                   class="btn btn-danger btn-sm">
                   <i class="fas fa-trash-alt"></i>
                   <b></b></button>
