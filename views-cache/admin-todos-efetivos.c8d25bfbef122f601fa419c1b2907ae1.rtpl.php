<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content">
    <div class="content-inside">
      <div class="my-4">
        ...
        <a style="width: 25%;" href="/admin/registrar-efetivos" class="btn btn-primary btn-sm"><i
        ...
        <div class="search" style="float: right">
          <form action="/admin/todos-efetivos" method="get">
          ...
          <table class=" table table-hover table-sm  table-bordered">
            ...
            <tbody>
              ...
              <tr style="font-size: 15px;font-weight: normal;">
                ...
                <td>
                  <center> <a href="/admin/efetivo/editar/<?php echo $value1["id_efetivo"]; ?>" class="btn btn-success btn-sm"><i
                        class="fas fa-pen"></i><b></b></a></center>
                </td>
                <td>
                  <center>
                    <button
                      onclick="deletar('<?php echo $value1["id_efetivo"]; ?>','<?php echo $value1["nome_servidor"]; ?>','/admin/efetivos/delete/<?php echo $value1["id_efetivo"]; ?>','Excluir servidor')"
        ...
        <?php } ?>
        <br><br><a href="/admin/utilidades" class="btn btn-info btn-xs"><i
